...
class A1cConversionFacadeBean : A1cConversionFacade {

    val glucoseConversionFacade: GlucoseConversionFacade

    @Throws(UnknownUnitException::class)
    override fun estimateA1c(value: String, unit: String?): A1cDTO {
        val glucoseConversionResult = BloodGlucoseConverter.convert(value, unit)

        return estimateA1c(glucoseConversionResult!!)
    }

    override fun estimateAverage(value: String): A1cDTO {
        val a1c = java.lang.Double.valueOf(value)
